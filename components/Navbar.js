  ...
  const [navbar, toggleNavbar] = useState(false);
    ...
    return (
      <div>
        ...
        <div className={`fixed top-20 left-[2.5rem] bg-gray-200/95 backdrop-blur-lg w-[calc(100vw-80px)] shadow-lg shadow-white/25 rounded-xl xs:${navbar ? 'flex' : 'hidden'} lg:hidden z-10`}>
