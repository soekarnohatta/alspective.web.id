        ...
        <div className={inter.className}>
            <div className="bg-[#000627] h-20 text-white px-8 xs:hidden lg:grid grid-cols-3 justify-between items-center">
                ...
                <div className="grid justify-items-end gap-1">
                    ...
                    <div className="flex gap-2 text-xl">
                        <a href="https://www.tiktok.com/@alspective" target="_blank" rel="noreferrer"><FaTiktok /></a>
                        <a href="https://www.instagram.com/alspective" target="_blank" rel="noreferrer"><FaInstagram /></a>
                    </div>
                </div>
            </div>
            <div className="w-screen bg-gradient-to-t from-[#000627] via-[#000627] fixed bottom-0 flex xs:flex-col sm:flex-row justify-center items-center text-white xs:gap-1 sm:gap-8 lg:hidden pt-24 xs:pb-2 sm:pb-3">
                <div className="flex flex-col">
                    <h1 className="bg-gradient-to-b from-white to-gray-300 inline-block text-transparent bg-clip-text font-ethnocentric text-center text-lg leading-none">STEP RIGHT UP<br />TO BE A STAR</h1>
                    <p className="text-center text-[10px]">© 2023 Alspective</p>
                </div>
                <div className="flex justify-center items-center xs:gap-1 sm:gap-2 xs:text-xs sm:text-lg">
                    ...
                    <p className="text-sm">@alspective</p>
                </div>
            </div>
        </div>
    )
